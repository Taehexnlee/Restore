            ...
            {basket.items.map( item => (
              ...
              >
                ...
                <TableCell align="center">
                  ...
                  <LoadingButton loading={status==='pending' + item.productId + 'rem'} 
                  ...
                  {item.quantity}
                  <LoadingButton loading={status==='pending' + item.productId} 
                ...
                <TableCell align="right">
                  <LoadingButton loading={status==='pending' + item.productId +'del'} 
                  onClick={()=> dispatch(removeBasketItemAsync({
